...
Les deux premières conditions traduisent une exigence de sincérité de la sollicitation : un donateur est sollicité au regard d'un plan chiffré et d'un résultat annoncé. Elles étaient présentées à l'association comme des recommandations et sont devenues bloquantes le 17 août 2026. Elles sont appliquées dans l'interface et, indépendamment, par le serveur, avec des règles identiques de part et d'autre. **Elles s'ajoutent au verrou de vérification du dossier d'identification et ne s'y substituent pas.**
