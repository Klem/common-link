...
-- =============================================================
-- V61 — Alertes de conformité LCB-FT (épique E4, prompt 16)
-- Une alerte par couple (origine, sujet). Cycle : PENDING → IN_REVIEW → CLOSED.
-- Déduplication via index partiel : une seule alerte ouverte par (origine, sujet).
