...
/** Réponse API représentant un bénéficiaire effectif (nom déchiffré par le serveur). */
...
/** Corps de requête pour l'ajout d'un bénéficiaire effectif par le curateur. */
