...
export default function MollieConnectSuccessPage() {
  const t = useTranslations('dashboard.molliePopup.success');

  useEffect(() => {
    window.opener?.postMessage({ type: MolliePopupMessage.CONNECTED }, window.location.origin);
